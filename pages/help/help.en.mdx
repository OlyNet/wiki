...
Alternatively (e.g. if your current bandwidth doesn't allow watching video) you can use this [manual](https://github.com/Lo4nsh4rk/wiki/files/11143073/TL-WR940N.Config_eng.pdf).
...
<Tabs items={['High-rise', 'Bungalow', 'Double Bungalow', 'Hillside']}>
  <Tab>At the power outlets left of the wardrobe</Tab>
  <Tab>On the upper floor below the radiator</Tab>
  <Tab>
    In the lowest compartment of the shelf in the "living area" on the ground
    floor
  </Tab>
  <Tab>At the power outlets under the desk</Tab>
</Tabs>

### Into which outlet and which port should I plug my cable?

The exact port is specified on the IP-sheet:
![The exact port is specified on the IP-sheet.](/Dose.png)
