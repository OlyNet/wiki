...
Sadly, we cannot do anything to change this. If you internet connection also 
is inconsistent, please check the section below this one.

### My internet is inconsistent, what can I do?
You can try the following approaches:
* If you are using a WIFI router and connect to the internet via this WIFI, try 
    to directly connect to your router via an ethernet cable instead. Plug an 
...
* If you are using a rather cheap WIFI router, you can try upgrading to a more powerful one.
    ...
    [in our office during the opening hours](/en#opening-hours).
* Finally, if the problem still persists, you can try to use a different ethernet cable to connect to 
    ...
    [in our office during the opening hours](/en#opening-hours).
* If the problem still persists, we can visit your appartment and check whether your 
...
* Hochhaus:
* Bungalow: In the upper story below the heater
* Doppelbungalow: In the ground floor in the lowest compartment of the shelf in the "living area"
...
Please contact the [Studentenwerk](wohnen-team1@stwm.de) to resolve this issue.
...
[office@olynet.club](office@olynet.club) or stop by in our office during the [opening hours](/en#opening-hours).
