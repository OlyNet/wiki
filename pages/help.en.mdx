...
Alternatively (e.g. if your current bandwidth doesn't allow watching video) you can use this [manual](https://github.com/OlyNet/wiki/files/11142486/TL-WR940N.Config_eng.docx)
